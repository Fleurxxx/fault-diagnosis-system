      ...
      <div class="bottom">
        <el-row class="table">
          <el-table
            ...
            <el-table-column prop="id" label="密钥id" width="180px" />
            <el-table-column prop="secret" label="IP" width="200px"/>
            <!-- <el-table-column prop="title" label="接口名称" width="200" /> -->
...
const getRecords = () => {
  //mock模拟数据
  axios.get("/interface/getbrowsing", {
    // params: {
