              ...
              <el-col :span="15">
                  <el-aside width="260px">
                      ...
                      >
                          ...
                          <el-sub-menu index="2">
                              <template #title>
                                  {{"\xa0\xa0"}}<i class="fa fa-codepen"></i>{{"\xa0\xa0"}}
                                  <span>分类模型管理</span>
                              </template>
                          ...
                          <el-sub-menu index="3">
                              <template #title>
                                  ...
                                  <span>故障诊断</span>&nbsp;&nbsp;<Badge dot style="z-index:0;position: relative;top:-5px"></Badge>
                              </template>
                          ...
                          <el-sub-menu index="5">
                              ...
                              <el-menu-item index="/users">{{"\xa0\xa0\xa0\xa0"}}<i class="fa fa-users"></i>{{"\xa0\xa0"}}用户管理</el-menu-item>
                          </el-sub-menu>
                      </el-menu>
                  </el-aside>
